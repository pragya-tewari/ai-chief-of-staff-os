...
- [`activity.md`](activity.md) — a running record of jobs run and writes made (append-only).
- [`corrections.md`](corrections.md) — every correction you made, with what was rejected and what
